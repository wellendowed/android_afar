package com.strontium.doublenavdrawer;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Replace with your own action YEAH", Snackbar.LENGTH_LONG)
    ...
    private void displayRightNavigation(){
        ...
        navigationViewRight.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Toast.makeText(MainActivity.this, "Handle from right navigation", Toast.LENGTH_LONG).show();
                DrawerLayout drawer = (DrawerLayout)findViewById(R.id.drawer_layout);
                drawer.closeDrawer(GravityCompat.END);
                return true;
            }
